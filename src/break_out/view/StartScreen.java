...
public class StartScreen extends JPanel {
	...
	private JTextField playersName2;
	...
	private void initializeLeftMenu() {
		...
		leftMenu.add(new JLabel("Spielername2:"), "cell 0 3, growx, gapleft 5");
		leftMenu.add(playersName2, "cell 0 4, growx");
	...
	private void initializeScoreMenu() {
		...
		scoreMenu.add(pName,"cell 0 5, gaptop 5");
		scoreMenu.add(pScore,"cell 10 5, gaptop 5");
		scoreMenu.add(pName2, "cell 0 10, gaptop 5");
		scoreMenu.add(pScore2,"cell 10 10, gaptop 5");
	...
	public String getPlayerName2() { return playersName2.getText(); }
	
	/** Returns the players Score
	 * @return Thhe score of the player in the JTextfield view.getGame().getLevel().getScore()
	 */
	public int getPlayersScore() {
		return view.getGame().getPlayer1().getScore();
	}

	public int getPlayersScore2(){
		return view.getGame().getPlayer2().getScore();
	}
	...
	/**
	 *  Shows the name of the player in the end of the game 
	 */
	public void pName() {
		pName.setText(getPlayersName());
		pName2.setText(getPlayerName2());
	}
	
	/**
	 * Shows the score of the player in the end of the game
	 */
	public void pScore() {
		pScore.setText(Integer.toString(getPlayersScore()));
		pScore2.setText(Integer.toString(getPlayersScore2()));
	}
